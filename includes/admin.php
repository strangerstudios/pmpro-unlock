 ...
 * @since 0.1.0
 */
function pmpro_unlock_admin_notice_activation_hook() {
	// Create transient data.
	set_transient( 'pmproup-admin-notice', true, 5 );
}
register_activation_hook( PMPRO_UNLOCK_BASENAME, 'pmpro_unlock_admin_notice_activation_hook' );
 ...
 * @since 0.1.0
 */
function pmpro_unlock_admin_notice() {
...
add_action( 'admin_notices', 'pmpro_unlock_admin_notice' );
 ...
 */
function pmpro_unlock_plugin_action_links( $links ) {
...
add_filter( 'plugin_action_links_' . PMPRO_UNLOCK_BASENAME, 'pmpro_unlock_plugin_action_links' );
 ...
 */
function pmpro_unlock_plugin_row_meta( $links, $file ) {
...
add_filter( 'plugin_row_meta', 'pmpro_unlock_plugin_row_meta', 10, 2 );